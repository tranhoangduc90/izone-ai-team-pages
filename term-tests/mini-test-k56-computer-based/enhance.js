(function () {
  ...
  const isDemo = ['complete', 'listening-only', 'writing-prep', 'writing', 'reading', 'listening'].includes(query.get('demo'));
    ...
    function renderTimer() {
      ...
      if (remainingSeconds !== lastRenderedSecond) {
        ...
        phase.textContent = planningPhase
          ...
          : 'Viết bài Paragraph · còn ' + formatMinutes(remainingSeconds) + ' phút';
  ...
  if (topbarTitle) topbarTitle.textContent = 'Mini Test · Khóa 56';
