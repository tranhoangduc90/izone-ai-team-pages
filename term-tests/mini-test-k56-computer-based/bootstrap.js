(function () {
  ...
  if (['complete', 'listening-only', 'writing-prep', 'writing', 'reading', 'listening'].includes(demoMode)) {
    ...
    Promise.resolve()
      .then(() => loadScript('../k56-mini-shared/app.js?v=20260914-mini-writing-revision-v1-student-feedback-v1-html-v2'))
  ...
  async function enterExam(started, audioElement = null) {
    ...
    previewAudio.remove();
    revokePreview();
    await loadScript('../k56-mini-shared/app.js?v=20260914-mini-writing-revision-v1-student-feedback-v1-html-v2');
