(function () {
  ...
  function setupBufferedAudio(listeningForm) {
    ...
    function reportAudioProgress(playbackState, keepalive = false) {
      ...
      if (!examSessionToken || !examStarted || !['term-test-1-k56', 'term-test-2-k56', 'mini-test-k56', 'substitute-test-2-k67'].includes(testConfig.slug)) return Promise.resolve(null);
  ...
  if (topbarTitle) topbarTitle.textContent = 'Substitute Test 2 · Khóa 67';
