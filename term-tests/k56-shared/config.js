...
window.TERM_TEST_APP_CONFIG = Object.freeze({
  API_BASE_URL: isLocalPreview ? window.location.origin : (requestedClass === 'IC2264' ? ic2264Api : demoApi),
  API_BASE_URLS: isLocalPreview ? [window.location.origin] : [demoApi, ic2264Api],
