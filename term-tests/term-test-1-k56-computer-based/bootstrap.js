(function () {
  ...
  if (['complete', 'listening-only', 'writing-prep', 'writing'].includes(demoMode)) {
    ...
    Promise.resolve()
      .then(() => loadScript('../k56-shared/app.js?v=20260912-load-guard-v1-student-feedback-v1-html-v2-teacher-parity-v1'))
  ...
  async function enterExam(started, audioElement = null) {
    ...
    previewAudio.remove();
    revokePreview();
        await loadScript('../k56-shared/app.js?v=20260912-load-guard-v1-student-feedback-v1-html-v2-teacher-parity-v1');
