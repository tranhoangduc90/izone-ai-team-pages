...
test('cả bootstrap chính/dự phòng và answer sheet đều dùng revision cache mới', () => {
  for (const path of ['term-tests/term-test-2-k56-computer-based/bootstrap.js','term-tests/term-test-2-k56-computer-based/index.html','term-tests/term-test-2-k56/index.html']) {
    const text = fs.readFileSync(path,'utf8');
    assert.match(text,/20260913-writing-revision-v1/);
